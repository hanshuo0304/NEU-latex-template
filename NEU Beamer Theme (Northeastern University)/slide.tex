...
% The lateset NEU-Beamer-Theme is modified by Han Shuo.
% The latex template file for NEU can be found here:
% https://github.com/hanshuo0304/NEU-latex-template
...
\author{韩硕}
\institute{东北大学测绘工程系}
\title{NEU Beamer Theme}
\subtitle{使用LATEX制作精致的学术演示文档}
\date{2025年4月}
\usepackage{NEU_Beamer}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.4\linewidth]{pic/neu-logo.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    ...
    % 除了alert，手动在里面插 \pause 也能达成“一页一单元”的效果
        ...
        \item 好多学校都有专属的Beamer主题，NEU也不能没有！
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.5\linewidth]{pic/neu-logo.png}
        \caption{图片}
    \end{figure}
\end{frame}
